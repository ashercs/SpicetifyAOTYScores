...
<?xml version="1.0" ?><svg fill="white" height="20" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M 8.386719 1.800781 L 7.785156 2.398438 L 3.601562 2.398438 L 3.601562 4.800781 L 20.398438 4.800781 L 20.398438 2.398438 L 16.214844 2.398438 L 15.613281 1.800781 L 15.015625 1.199219 L 8.984375 1.199219 Z M 8.386719 1.800781 M 4.804688 13.402344 C 4.816406 20.230469 4.816406 20.816406 4.867188 20.96875 C 4.964844 21.300781 5.046875 21.480469 5.191406 21.699219 C 5.527344 22.222656 5.996094 22.554688 6.644531 22.734375 C 6.808594 22.78125 7.261719 22.785156 12 22.785156 C 16.738281 22.785156 17.191406 22.78125 17.355469 22.734375 C 18.003906 22.554688 18.472656 22.222656 18.808594 21.699219 C 18.953125 21.480469 19.035156 21.300781 19.132812 20.96875 C 19.183594 20.816406 19.183594 20.230469 19.195312 13.402344 L 19.199219 6 L 4.800781 6 Z M 4.804688 13.402344 "/></svg>`;
  ...
  async function getPageLink(artist2, album2, firstiteration) {
    ...
    if (album2 == "Sign O The Times") {
      album2 = 'Sign "\u262E" the Times';
    }
    let song = artist2 + " " + album2;
    ...
    for (let i = 0; i < $$("div.artistTitle").length; i++) {
      ArtistList.push((_a2 = $$(".artistTitle")[i]) == null ? void 0 : _a2.children[0].data);
      AlbumList.push($$(".albumTitle")[i].children[0].data);
    }
    const classNames = /* @__PURE__ */ new Set();
    $$("*[class]").each((index2, element) => {
    ...
    if (ArtistList.length == 1) {
      if ((_c = (_b = $$(".artistTitle")[0].parentNode.parentNode) == null ? void 0 : _b.children[2]) == null ? void 0 : _c["attribs"]["href"]) {
        aotyUrl = "https://www.albumoftheyear.org" + ((_e = (_d = $$(".artistTitle")[0].parentNode.parentNode) == null ? void 0 : _d.children[2]) == null ? void 0 : _e["attribs"]["href"]);
      }
    }
    if (ArtistList.length > 1) {
      let ArtistSimArray = [];
      for (let h = 0; h < ArtistList.length; h++) {
        ...
        if (i !== 0) {
          SimToArtistJSON += `"${similarity(ArtistList[i], artist2)}": "${ArtistList[i]}",
`;
          if (((_h = (_g = (_f = $$(".artistTitle")[i]) == null ? void 0 : _f.parentNode) == null ? void 0 : _g.children[2]) == null ? void 0 : _h["attribs"]["href"]) != void 0) {
            ArtistToUrlJSON += `"${ArtistList[i]}": "${(_k = (_j = (_i = $$(".artistTitle")[i]) == null ? void 0 : _i.parentNode.parentNode) == null ? void 0 : _j.children[2]) == null ? void 0 : _k["attribs"]["href"]}",
`;
          }
          if (((_n = (_m = (_l = $$(".artistTitle")[i]) == null ? void 0 : _l.parentNode.parentNode) == null ? void 0 : _m.children[2]) == null ? void 0 : _n["attribs"]["href"]) != void 0) {
            ArtistToUrlJSON += `"${ArtistList[i]}": "${(_q = (_p = (_o = $$(".artistTitle")[i]) == null ? void 0 : _o.parentNode) == null ? void 0 : _p.children[2]) == null ? void 0 : _q["attribs"]["href"]}",
`;
          }
...
`;
          ArtistSimArray.push(similarity(ArtistList[i], artist2));
          if (((_t = (_s = (_r = $$(".artistTitle")[i]) == null ? void 0 : _r.parentNode) == null ? void 0 : _s.children[2]) == null ? void 0 : _t["attribs"]["href"]) != void 0) {
            AlbumToUrlJSON += `"${AlbumList[i].replaceAll('"', '\\"')}": "${(_w = (_v = (_u = $$(".artistTitle")[i]) == null ? void 0 : _u.parentNode) == null ? void 0 : _v.children[2]) == null ? void 0 : _w["attribs"]["href"]}",
`;
          }
          if (((_z = (_y = (_x = $$(".artistTitle")[i]) == null ? void 0 : _x.parentNode.parentNode) == null ? void 0 : _y.children[2]) == null ? void 0 : _z["attribs"]["href"]) != void 0) {
            AlbumToUrlJSON += `"${AlbumList[i].replaceAll('"', '\\"')}": "${(_C = (_B = (_A = $$(".artistTitle")[i]) == null ? void 0 : _A.parentNode.parentNode) == null ? void 0 : _B.children[2]) == null ? void 0 : _C["attribs"]["href"]}",
`;
          }
        }
        if (i == 0) {
          ...
          if (((_F = (_E = (_D = $$(".artistTitle")[i]) == null ? void 0 : _D.parentNode) == null ? void 0 : _E.children[2]) == null ? void 0 : _F["attribs"]["href"]) != void 0) {
            ArtistToUrlJSON += `"${ArtistList[i]}": "${(_I = (_H = (_G = $$(".artistTitle")[i]) == null ? void 0 : _G.parentNode.parentNode) == null ? void 0 : _H.children[2]) == null ? void 0 : _I["attribs"]["href"]}"
}`;
          }
          if (((_L = (_K = (_J = $$(".artistTitle")[i]) == null ? void 0 : _J.parentNode.parentNode) == null ? void 0 : _K.children[2]) == null ? void 0 : _L["attribs"]["href"]) != void 0) {
            ArtistToUrlJSON += `"${ArtistList[i]}": "${(_O = (_N = (_M = $$(".artistTitle")[i]) == null ? void 0 : _M.parentNode) == null ? void 0 : _N.children[2]) == null ? void 0 : _O["attribs"]["href"]}"
}`;
          }
          ArtistToSimJSON += `"${ArtistList[i]}": "${similarity(
            ArtistList[i],
          ...
          ArtistToAlbumJSON += `"${ArtistList[i]}": ${AlbumList[i]}`;
          if (((_R = (_Q = (_P = $$(".artistTitle")[i]) == null ? void 0 : _P.parentNode) == null ? void 0 : _Q.children[2]) == null ? void 0 : _R["attribs"]["href"]) != void 0) {
            AlbumToUrlJSON += `"${AlbumList[i].replaceAll('"', '\\"')}": "${(_U = (_T = (_S = $$(".artistTitle")[i]) == null ? void 0 : _S.parentNode) == null ? void 0 : _T.children[2]) == null ? void 0 : _U["attribs"]["href"]}"
}`;
          }
          if (((_X = (_W = (_V = $$(".artistTitle")[i]) == null ? void 0 : _V.parentNode.parentNode) == null ? void 0 : _W.children[2]) == null ? void 0 : _X["attribs"]["href"]) != void 0) {
            AlbumToUrlJSON += `"${AlbumList[i].replaceAll('"', '\\"')}": "${(__ = (_Z = (_Y = $$(".artistTitle")[i]) == null ? void 0 : _Y.parentNode.parentNode) == null ? void 0 : _Z.children[2]) == null ? void 0 : __["attribs"]["href"]}"
}`;
          }
          ArtistSimArray.push(similarity(ArtistList[i], artist2));
        }
      ...
      if (countInstances(ArtistToUrlJSON, MostSimArtist) > 1) {
        for (let h = 0; h < lines.length; h++) {
          ...
          if (line.indexOf(`"${MostSimArtist}":`) != -1) {
            DupeArtistArray.push(line.split(`"${MostSimArtist}": `)[1]);
          }
        }
      }
      if (DupeArtistArray.length >= 1) {
        for (let a = 0; a < DupeArtistArray.length; a++) {
          if (a !== DupeArtistArray.length - 1) {
            SimToAlbumJSON += `"${similarity(DupeArtistArray[a], album2)}": "${DupeArtistArray[a].replaceAll('"', '\\"')}",
`;
          }
          if (a == DupeArtistArray.length - 1) {
            SimToAlbumJSON += `"${similarity(DupeArtistArray[a], album2)}": "${DupeArtistArray[a].replaceAll('"', '\\"')}"
          ...
          DupeArtistSimArr.push(similarity(DupeArtistArray[a], album2));
        }
      }
      if (DupeArtistArray.length >= 1) {
  ...
  async function update2() {
    ...
    if (!Spicetify.Player.data.playbackId && !Spicetify.Player.data.playback_id)
      return;
    const id = (_a2 = Spicetify.Player.data.playbackId) != null ? _a2 : Spicetify.Player.data.playback_id;
    ...
    let {
      ...
      album_track_number,
      album_disc_number
    } = (_d = (_b = Spicetify.Player.data.item) == null ? void 0 : _b.metadata) != null ? _d : (_c = Spicetify.Player.data.track) == null ? void 0 : _c.metadata;
    ...
    try {
      ...
      if (artist_name == "John Zorn" && album_title == "Electric Masada") {
        artist_name = "Electric Masada";
      }
      ...
      if (album_title == "Sign O' The Times") {
        album_title = 'Sign "\u262E" the Times';
      }
      ...
      if (rating[5] === "True") {
        ...
        if (document.querySelector(
          ...
          songTitleBox = document.querySelector(
            "#main > div > div.Root__top-container > div.Root__now-playing-bar > footer > div.main-nowPlayingBar-nowPlayingBar > div.main-nowPlayingBar-left > div > div.main-nowPlayingWidget-trackInfo.main-trackInfo-container > div.main-trackInfo-name > div > span > span > div > span"
          );
        }
        if (songTitleBox) {
      ...
      infoContainer.style.gridTemplate = '"title title" "badges subtitle" "genres genres" "rating rating" / auto 1fr auto auto';
  ...
  async function main() {
    while (!Spicetify.CosmosAsync || !Spicetify.showNotification)
      await sleep(500);
    update2();
    Player.addEventListener("songchange", update2);
  }
